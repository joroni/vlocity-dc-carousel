...
class VlocityDCCarousel extends PolymerElement {
  ...
  @media screen and (max-width: 1024px) {   .w3-hide-small, .w3-hide-medium { { display: none; } }
  
  
  @media screen and (max-width: 680px) {    .w3-hide-large, .w3-hide-small { display: none; } }
  
  @media screen and (max-width: 424px) {    .w3-hide-large, .w3-hide-medium  { display: none; } }
